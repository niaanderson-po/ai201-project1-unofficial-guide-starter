...
- Aryansh – [Preparing for Contests](https://darrenyao.com/usacobook/cpp.pdf)
- CF – [E869120 - A Way to Practice CP: going from CF rating 1000 to 2000](https://codeforces.com/blog/entry/66909)
...
- Read someone else's solution code (if publicly available). This can often be helpful even if you've already solved the problem yourself, as top competitors sometimes come up with cleaner approaches than the official one.
...
You can also check my Github and my IOI interview for more information.
